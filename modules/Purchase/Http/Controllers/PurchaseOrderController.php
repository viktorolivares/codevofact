...
class PurchaseOrderController extends Controller
{
    ...
    public function download($external_id, $format = "a4") {
        ...
        if (!$purchase_order) throw new \RuntimeException("El código {$external_id} es inválido, no se encontro la cotización de compra relacionada");
    ...
    public function downloadAttached($external_id) {
        ...
        if (!$purchase_order) throw new \RuntimeException("El código {$external_id} es inválido, no se encontro la orden de compra relacionada");
