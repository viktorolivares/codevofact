                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" :class="{ 'has-danger': errors.aditional_information }">
                            ...
                            <small class="form-control-feedback" v-if="errors.aditional_information"
                                v-text="errors.aditional_information[0]"></small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <el-select v-model="form.customer_id" filterable remote popper-class="el-select-customers"
                                clearable placeholder="Nombre o número de documento" :remote-method="searchRemoteCustomers"
        ...
        searchRemoteCustomers(input) {
            if (input && input.length > 0) {
                ...
                this.$http
                    ...
                    .catch(error => {
                        console.error("Error fetching remote customers:", error);
                        this.loading_search = false;
                    });
            } else {
                this.filterCustomers();
